    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Infinex Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Infinex Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  infinex-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Infinex in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 INFINEX, 0.1 INFINEX, 1 INFINEX and 10 INFINEX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://infinexpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://infinexpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Infinex Core is shutting down...") + "<br /><br />" +
