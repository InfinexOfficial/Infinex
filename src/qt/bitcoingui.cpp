    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Infinex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Infinex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and infinex: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Infinex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Infinex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Infinex Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Infinex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Infinex addresses"));
    ...
    openAction->setStatusTip(tr("Open a infinex: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Infinex Core help message to get a list with possible Infinex Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Infinex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Infinex network", "", count));
    } else {
...
{
    QString strTitle = tr("Infinex Core"); // default title
