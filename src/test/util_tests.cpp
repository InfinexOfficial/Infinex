...
BOOST_AUTO_TEST_CASE(test_ParseFixedPoint)
{
    ...
    BOOST_CHECK(ParseFixedPoint("128801288099.1288012880", 8, &amount));
    BOOST_CHECK_EQUAL(amount, 1288012880128801288099LL);
    BOOST_CHECK(ParseFixedPoint("-128801288099.1288012880", 8, &amount));
    BOOST_CHECK_EQUAL(amount, -1288012880128801288099LL);
    ...
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000009", 8, &amount));
    BOOST_CHECK(!ParseFixedPoint("-1288012880999.1288012880", 8, &amount));
    BOOST_CHECK(!ParseFixedPoint("1288099012880.012880999", 8, &amount));
