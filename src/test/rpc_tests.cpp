...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(2012880128801288090LL).write() == "201288099.128809990");
    BOOST_CHECK(ValueFromAmount(2012880128801288099LL).write() == "201288099.1288012880");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("201288099.12880999")), 2012880128801288090LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("201288099.1288012880")), 2012880128801288099LL);
