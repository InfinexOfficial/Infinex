...
#define BOOST_TEST_MODULE Infinex Test Suite

#include "test_infinex.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_infinex_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
