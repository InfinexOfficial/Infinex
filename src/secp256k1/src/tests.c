...
void test_rand_bits(int rand32, int bits) {
    ...
    static const uint32_t mults[6] = {1, 3, 21, 289, 0x12880, 0x80402011};
...
void run_rand_int(void) {
    static const uint32_t ms[] = {1, 3, 17, 1000, 13771, 1288099, 33554432};
...
void run_ecmult_chain(void) {
    ...
    for (i = 0; i < 200*count; i++) {
        ...
        /* verify */
        if (i == 13880) {
            /* expected result after 13880 iterations */
