...
public:
    ...
    bool IsValidForPayment()
    {
        ...
        if(!sporkManager.IsSporkActive(SPORK_REQUIRE_SENTINEL_FLAG) &&
    ...
    /// Is the input associated with collateral public key? (and there is 1000 INFINEX - checking if valid masternode)
