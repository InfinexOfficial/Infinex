...
/** Verify current tip chain work similar or exceed SPORK recorded minimum chain work */
bool IsExceedMinimumChainWork(bool reCheckExceedMinimumChainWork = false);
/** Verify current chain contain hash displayed in SPORK */
bool IsBestBlockHashFound(bool reCheckBestBlockHashFound = false);
