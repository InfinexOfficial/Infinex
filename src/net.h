...
static const unsigned int DEFAULT_MISBEHAVING_BANTIME = 60 * 60 * 1;  // Default 1-hour ban
...
public:
    ...
    // because it's used in many Infinex-specific places (masternode, privatesend).
