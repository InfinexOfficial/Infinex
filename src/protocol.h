...
extern const char *DEXTRADEPAIRS;
extern const char *DEXGETTRADEPAIR;
extern const char *DEXUSERBALANCE;
extern const char *DEXUSERBALANCES;
extern const char *DEXGETUSERBALANCE;
extern const char *DEXUSERTRADE;
extern const char *DEXUSERTRADES;
extern const char *DEXGETUSERTRADE;
extern const char *DEXACTUALTRADE;
extern const char *DEXACTUALTRADES;
extern const char *DEXGETACTUALTRADE;
extern const char *DEXUSERTRADECANCEL;
extern const char *DEXUSERTRADESCANCEL;
extern const char *DEXGETUSERTRADECANCEL;
extern const char *DEXUSERDEPOSIT;
extern const char *DEXUSERDEPOSITS;
extern const char *DEXGETUSERDEPOSIT;
extern const char *DEXUSERWITHDRAW;
extern const char *DEXUSERWITHDRAWS;
extern const char *DEXGETUSERWITHDRAW;
extern const char *DEXUSERWALLETADDRESS;
extern const char *DEXUSERWALLETADDRESSES;
extern const char *DEXGETUSERWALLETADDRESS;
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Infinex Core nodes, and is unset by SPV clients or other peers that just want
    // network services but don't provide them.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // Infinex Core does not support this but a patch set called Bitcoin XT does.
