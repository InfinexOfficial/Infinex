...
public:
	...
	bool ReturnTradeCancelBalance(CCancelTrade& cancelTrade);
	...
	bool InputActualTradeFromNetwork(const std::shared_ptr<CActualTrade>& actualTrade, CNode* pfrom, CConnman& connman);
