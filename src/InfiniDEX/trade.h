...
public:
	...
	void ProcessUserBuyRequest(const std::shared_ptr<CUserTrade>& userTrade, CUserTradeSetting& setting, CTradePair& tradePair);
	void ProcessUserSellRequest(const std::shared_ptr<CUserTrade>& userTrade, CUserTradeSetting& setting, CTradePair& tradePair);
	bool InputUserBuyTrade(const std::shared_ptr<CUserTrade>& userTrade);
	bool InputUserSellTrade(const std::shared_ptr<CUserTrade>& userTrade);
	void InputMatchUserBuyRequest(const std::shared_ptr<CUserTrade>& userTrade, CUserTradeSetting& setting, CTradePair& tradePair, bool InitialCheck = false);
	void InputMatchUserSellRequest(const std::shared_ptr<CUserTrade>& userTrade, CUserTradeSetting& setting, CTradePair& tradePair, bool InitialCheck = false);
