...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "InfinexNetwork") type = InfinexNetwork;
    if(strType == "InfinexNetworkVariable") type = InfinexNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == InfinexNetwork) s = "InfinexNetwork";
    if(type == InfinexNetworkVariable) s = "InfinexNetworkVariable";
