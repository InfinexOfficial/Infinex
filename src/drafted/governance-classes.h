 ...
 *
 *   // network
 *   CInfinexNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CInfinexNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CInfinexNetwork(UniValue objIn)
    {
...
// // can be under: InfinexNetwork
// //   -- signature requirements : Key1(User)
// class CInfinexNetworkVariable : public CGovernanceObject
// {
// private:
