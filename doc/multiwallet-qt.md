...
Only requiring some minor changes is infinex.cpp.
...
Changes to infinex.cpp
----------------------
infinex.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
