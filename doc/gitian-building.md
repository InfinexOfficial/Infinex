...
*Setup instructions for a Gitian build of Infinex Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Infinex
...
- [Building Infinex Core](#building-infinex-core)
...
Clone the git repositories for Infinex Core and Gitian.
...
in the Infinex Core repository under 'Fetch and build inputs' to install sources which require
...
To build Infinex Core (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Infinex Core repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/infinex/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/InfinexOfficial/Infinex
...
For example:
```bash
URL=https://github.com/crowning-/infinex.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit infinex=${COMMIT} --url infinex=${URL} ../infinex/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit infinex=${COMMIT} --url infinex=${URL} ../infinex/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit infinex=${COMMIT} --url infinex=${URL} ../infinex/contrib/gitian-descriptors/gitian-osx.yml
```