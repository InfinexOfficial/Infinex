...
Infinex Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 12881.
...
However, in open source software such as Infinex Core, where everyone uses
...
pay attention to for reviewers of Infinex Core code.

General Infinex Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Infinex Core uses tinyformat, which is type safe. Leave them out to avoid confusion
